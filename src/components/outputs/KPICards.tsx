import { TrendingUp, TrendingDown, DollarSign, BarChart2, PieChart, Award } from 'lucide-react'
    ...
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
      {cards.map((card, i) => {
        ...
        return (
          <div
            key={i}
            className={`bg-card rounded-xl shadow-sm border-l-4 ${card.color} p-4 lg:p-5 space-y-2`}
          >
