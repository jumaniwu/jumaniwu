...
export default function ReportPage() {
  ...
  async function handleExportPDF() {
    toast({ title: 'Menyiapkan PDF…', description: 'Harap tunggu beberapa saat.' })
    try {
      await exportToPDF('report-content', currentInputs.namaProyek || 'propfs-report')
      toast({ title: 'PDF berhasil diexport', variant: 'success' })
    } catch {
      toast({ title: 'Gagal export PDF', description: 'Coba gunakan Print Browser (Ctrl+P)', variant: 'destructive' })
    }
  }
  ...
  return (
    <>
      ...
      <div id="report-content" className="bg-white text-gray-900 max-w-[900px] mx-auto">
        ...
        {/* ── Page 1: Cover ── */}
        <div className="print-break-before min-h-[297mm] flex flex-col justify-between p-12 bg-navy text-white">
          <div>
        ...
        <div className="print-break-before p-10 space-y-6">
